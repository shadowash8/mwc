...
void server_handle_request_drag(struct wl_listener *listener, void *data) {
  struct wlr_seat_request_start_drag_event *event = data;
  wlr_seat_start_pointer_drag(server.seat, event->drag, event->serial);
}

void server_handle_request_start_drag(struct wl_listener *listener,
                                      void *data) {
...
void server_handle_destroy_drag(struct wl_listener *listener, void *data) {
...
void dnd_icons_move(uint32_t x, uint32_t y) {
