...
layer_surface_handle_commit(struct wl_listener *listener, void *data) {
  struct ashwc_layer_surface *layer_surface = wl_container_of(listener, layer_surface, commit);
...
layer_surface_handle_new_popup(struct wl_listener *listener, void *data) {
  struct ashwc_layer_surface *layer_surface = wl_container_of(listener,
...
void
layer_surfaces_commit_layer(struct ashwc_output *output,
